...
const USER_A_JOBS = [
  ...
  },
  {
    ...
    stage: "REJECTED" as const,
    priority: false,
    description: "Ad tech dashboard and analytics",
    applicationDate: new Date("2026-02-22"),
    deadline: null,
    compensationNotes: "Base: $155k–$175k",
    recruiterNotes: null,
    customNotes: "Applied late and posting was already closed. Never heard back until auto-rejection.",
  },
  {
...
const USER_B_JOBS = [
  ...
  },
  {
    ...
    company: "JetStream Networks",
    location: "Newark, NJ",
    stage: "REJECTED" as const,
    priority: false,
    description: "Network virtualization and cloud migration",
    applicationDate: new Date("2026-03-02"),
    deadline: null,
    compensationNotes: null,
    recruiterNotes: "Auto-rejection email 2 days after applying. Probably never reviewed my resume.",
    customNotes: "ATS black hole. Need to optimize resume for keywords next time.",
  },
  {
    title: "Backend Engineer",
    company: "StreamVault",
